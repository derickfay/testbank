...
"
				repeat with j from 2 to count of rows of answerTable
					if (value of cell i of column "Question ID") is (value of cell j of column "Question ID" of answerTable) then
						set outputString to outputString & "	" & (value of cell j of column "Answer Order" of answerTable) & " " & (value of cell j of column "Answer" of answerTable)
...
set resultFile to (choose file name with prompt "Save Test File" default name "Test") as text
